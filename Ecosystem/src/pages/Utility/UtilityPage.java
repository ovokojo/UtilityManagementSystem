 ...
 */
public class UtilityPage extends javax.swing.JFrame {
 ArrayList<MaintenanceRequest> allRequests= new MaintenanceRequestDirectory().getRequests();
 ArrayList<MaintenanceStaff> allStaff = new UtilityStaffDirectory().getStaff();
 MaintenanceRequest activeRequest;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UtilityPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UtilityPage().setVisible(true);
            }
        });
    }
